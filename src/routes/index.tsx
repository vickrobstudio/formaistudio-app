...
function HomePage() {
  return <main className="fixed inset-0 h-[100dvh] w-screen overflow-hidden bg-landing-paper">
    <section className="relative h-full w-full overflow-hidden bg-landing-paper">
      <img src={landingArtwork.url} alt="Watercolor collection of sculptural furniture and interior objects" width="1536" height="2732" fetchPriority="high" className="absolute inset-0 block size-full min-h-full min-w-full object-cover object-center" />
