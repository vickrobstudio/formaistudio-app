...
import landingArtwork from "@/assets/formai-landing-clean-final.png.asset.json";
...
function HomePage() {
  return <main className="min-h-[100svh] bg-background">
    <section className="relative min-h-[100svh] overflow-hidden">
      ...
      <nav aria-label="Legal" className="absolute bottom-[max(1.25rem,env(safe-area-inset-bottom))] left-1/2 z-10 flex -translate-x-1/2 items-center whitespace-nowrap text-[9px] tracking-[0.04em] text-primary-foreground sm:text-[11px]">
