...
function Dashboard() {
  ...
  })}{!signedIn && <Button asChild variant="outline" className="mt-6 w-full md:col-span-2"><Link to="/auth"><UserRound />Sign in or create account</Link></Button>}</section><ToolTabBar /></main>;
}