...
export const Route = createFileRoute("/dashboard")({ head: () => ({ meta: [{ title: "Dashboard — FormAI STUDIO" }, { name: "description", content: "Choose an AI interior design tool." }, { property: "og:title", content: "FormAI STUDIO Dashboard" }, { property: "og:description", content: "Five tools for AI interior creation." }] }), component: Dashboard });
