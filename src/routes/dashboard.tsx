...
import { ArrowRight, Cloud, History, UserRound, WalletCards } from "lucide-react";
...
const dashboardItems = [
  ...
  { icon: WalletCards, name: "Wallet", description: "Credits, subscriptions and receipts", to: "/wallet" },
] as const;
