...
export const Route = createFileRoute("/dashboard")({ head: () => ({ meta: [{ title: "Dashboard — Forma Studio" }, { name: "description", content: "Choose an AI interior design tool." }, { property: "og:title", content: "Forma Studio Dashboard" }, { property: "og:description", content: "Five tools for AI interior creation." }] }), component: Dashboard });
