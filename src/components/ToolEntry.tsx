...
export function ToolEntry({ eyebrow, title, description, steps, accept, cta }: { eyebrow: string; title: string; description: string; steps: string[]; accept: string; cta: string }) {
