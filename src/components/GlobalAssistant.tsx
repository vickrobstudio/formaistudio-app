...
export function GlobalAssistant() {
  ...
  return <>
    {!open && <button
      ...
      className="fixed bottom-[calc(1.25rem+env(safe-area-inset-bottom))] right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full border border-foreground/15 bg-background text-foreground shadow-lg transition-transform hover:scale-105 active:scale-95"
    >
