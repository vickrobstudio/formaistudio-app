...
-- 1) Flip existing profile if present
UPDATE public.profiles
SET has_free_access = true,
    updated_at = now()
WHERE lower(email) = 'tetiana.shanina@gmail.com';

-- 2) Update signup trigger to include the new VIP email
...
DECLARE
  ...
  vip_emails text[] := ARRAY['hello@vickrob.com','tetiana.shanina@gmail.com'];
BEGIN
